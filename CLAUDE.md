...
- **Neo4j data:** `/var/lib/neo4j/data/` (ext4, already on fast storage)
- **Neo4j config:** pagecache=20GB, heap=4GB (see scripts/configure-neo4j.sh)
- **Conda env:** `graphevo` (python 3.11, neo4j-driver, numpy, cyvcf2)
...
- Write plan to `tasks/tasks_todo.md` with checkable items
...
3. Log architectural decisions in `tasks/tasks_decisions.md`
4. After corrections: update `tasks/tasks_lessons.md`
5. After completion: add review section to `tasks/tasks_todo.md`
